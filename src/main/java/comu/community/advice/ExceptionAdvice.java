package comu.community.advice;

import comu.community.exception.CannotConvertHelperException;
...
public class ExceptionAdvice {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR) // 각 예외마다 사애 코드 지정
